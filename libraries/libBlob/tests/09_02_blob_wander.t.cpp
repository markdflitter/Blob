...
{
	Blob b = CreateBlob ().lifespan (1000U).HP (100U).starvationLevel (1000U).position (make_pt (10.1, 20.2)).speed (10.0).moveDirectionFn (fixed_angle);
...
TEST (test_09_02_blob_wander_t, wanders_in_a_circle)
{
	Blob b = CreateBlob ().position (make_pt (10.1, 20.2))
			      .lifespan (1000U).HP (100U).starvationLevel (1000U)
			      .speed (10.0).endurance (10U).moveDirectionFn (fixed_angle);
