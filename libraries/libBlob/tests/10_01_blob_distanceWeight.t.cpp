...
{
	Blob b1 = CreateBlob ().position (make_pt (10.0, 0.0)).lifespan (100U).HP (100U).starvationLevel (100U);
	Blob b2 = CreateBlob ();
...
{
	Blob b1 = CreateBlob ().position (make_pt (3.0, 4.0)).smell (5.0).lifespan (100U).HP (100U).starvationLevel (100U);
...
{
	Blob b1 = CreateBlob ().position (make_pt (3.0, 4.0)).smell (100.0).lifespan (100U).HP (100U).starvationLevel (100U);
	Blob b2 = CreateBlob ().position (make_pt (9.0, 12.0));
...
{
	Blob base = CreateBlob ().position (make_pt (3.0, 4.0)).smell (50.0).lifespan (100U).HP (100U).starvationLevel (100U);
...
TEST (test_10_01_blob_distanceWeight_t, better_smell_gives_higher_weight)
{
	...
	Blob lowSmellRange = CreateBlob ().position (make_pt (3.0, 4.0)).smell (50.0).lifespan (100U).HP (100U).starvationLevel (100U);
	Blob highSmellRange = CreateBlob ().position (make_pt (3.0, 4.0)).smell (100.0).lifespan (100U).HP (100U).starvationLevel (100U);
